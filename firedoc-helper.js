...
var enginePath = path.join(helper.editorRoot, 'api/engine');
var editorFrameworkPath = path.join(helper.editorRoot, 'api/editor-framework/lib');
var assetdbPath = path.join(helper.editorRoot, 'api/asset-db');

exports.generateBuiltin = function() {
  var doc = new Firedoc({
